...
to random_mind
  set intention random 2
end

to detective_mind
  if judge_times = 0[
    if judge = 1[
      set intention 0 ;;如果没有被骗，就一直骗人
    ]
    if judge = 0[
      ifelse trust = 1[set intention 1];;如果被骗了，就按照复读机来
      [set intention 0]
    ]
  ]
  if judge_times = 1[
